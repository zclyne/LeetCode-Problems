...
// 方法：越靠近图中间的节点，以它为根节点的树高度就越低
// 所以可以从外向内使用BFS来遍历图，初始状态下，只把所有出度为1的节点（即叶子结点）入队
// 对于当前正在访问的节点，将它的所有neighbor的出度--。如果这个neighbor的出度减到了1，说明它已经成为了一个新的叶子结点
// 将它入队
